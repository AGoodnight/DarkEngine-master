{
//the providencial has gone dark.
['the woods'],
...
['the jungle'],
//deadly and fraught with dangerous poisons, farther you see blazing peaks
['dantes peak'],
// Here you fight the last dragon, left to the fate of his own greed.
['the sea'],
// After defeating dante, you have acquired a boat, and you sail until you meet a Krakken and you fall.
['atlantis'],
// Here once sat the eldest of life, now gone higher into the heavens, they await to aid those of pure and clam merit. The guardian will test them here and only then may the warrior rise.
['beyond the sky'],
// The dream of a thousand nights, and at its end, the congregation will bestow the blessing of Eve to them.
['the carnival'],
...
{name:'forever',
    scenes:[
        {
        name:'the yard',
        lal:[200,200], // latitude and logitude
        background:'firered',
        ambush:0.2,
        take:[it.nothing]
        look:[
